...
const DICIONARIO = {
  en: {
    ...
    'Totais: as metas da primeira fase, as mesmas da página pública. Valores de setembro (receita, quilos e divisão): ilustrativos e coerentes com essas metas. A fila de hoje e as provas na cadeia leem o estado desta demonstração.': 'Totals: the first-phase targets, the same as on the public page. September values (revenue, kilos and split): illustrative and consistent with those targets. The queue for today and the on-chain proofs read the state of this demo.',
    ...
    'O projeto ainda não começou: esta tela é uma demonstração, com dados de exemplo. Quando o ciclo começar, cada número vai vir de uma prova: a coleta validada pela DeTrash, a venda registrada no Mercado e a divisão executada pelo contrato na Solana.': 'The project has not started yet: this screen is a demo with sample data. Once the cycle starts, each number will come from a proof: the collection validated by DeTrash, the sale logged in the Market and the split executed by the contract on Solana.',
    'Demonstração': 'Demo',
    'Exemplo:': 'Example:',
